#!/usr/bin/env bash
SCRIPT_NAME="steal-attack-9-lnd-victims-blockmaxweight=400000"
TOPOLOGY="$LN/topologies/topology-9-lnd-victims.json"
...
python3 -m commands_generator.commands_generator \
    --topology "$TOPOLOGY" \
    --establish-channels \
    --make-payments 1 3 13041 11000000 \
    --steal-attack 1 3 150 \
    --dump-data "$DATA_DIR.tmp" \
    --block-time 180 \
    --bitcoin-blockmaxweight 400000 \
